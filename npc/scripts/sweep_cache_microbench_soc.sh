...
BENCH_IMGS="$BENCH_PATH/build/microbench-riscv32e-ysyxsoc.bin"
BENCH_ARGS="train"
OUT_NAME="sweep-microbench-soc-train"
...
make -C $BENCH_PATH ARCH=riscv32e-ysyxsoc mainargs="$BENCH_ARGS" insert-arg
...
echo "== SoC Cache Sweep (MicroBench train) Start =="
MAX_JOBS=3
...
wait
echo "== SoC Cache Sweep (MicroBench train) Done =="
